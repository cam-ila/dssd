...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { client_number: @incident.client_number, description: @incident.description, incident_type: @incident.incident_type, state: @incident.state } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { client_number: @incident.client_number, description: @incident.description, incident_type: @incident.incident_type, state: @incident.state } }
